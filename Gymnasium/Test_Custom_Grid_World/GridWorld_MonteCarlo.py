...
def main():
    ...
    def test_agent(agent, env, num_episodes=5, render_episodes=3):
        ...
        print(f"\nTesting Monte Carlo agent for {num_episodes} episodes (rendering first {render_episodes})...")
        ...
        print(f"\n=== Monte Carlo Test Results over {num_episodes} episodes ===")
        ...
        # Display learned policy information
        print(f"\nLearned Policy Info:")
        print(f"Total state-action pairs learned: {len(agent.q_values)}")
